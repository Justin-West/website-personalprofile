...
${options.type === "route" ? `// Check the prop type of the entry function
${_http.HTTP_METHODS.map((method)=>`
if ('${method}' in entry) {
  checkFields<
    Diff<
      {
        ...
        compiler.hooks.compilation.tap(PLUGIN_NAME, (compilation)=>{
            compilation.hooks.processAssets.tapAsync({
                ...
                if (this.typedRoutes) {
                    ...
                    const assetPath = assetDirRelative + "/" + (0, _normalizePathSep).normalizePathSep(linkTypePath);
